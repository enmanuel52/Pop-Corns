...
@Composable
internal fun WatchlistMoviesContent(
    ...
    ObserveAsEvents(viewModel.sideEffectChannel) {
        when (it) {
            ...
            WatchlistHomeSideEffect.NavigateToLists -> Unit
            WatchlistHomeSideEffect.OpenDrawer -> Unit
        }
    }
            ...
            if (watchlist.isRefreshing) {
                ...
                items(watchlist.itemCount) { index ->
                    ...
                    movie?.let {
                        MovieWatchlistItem(
                            movie = movie,
                            removed = movie.id in uiState.removedItems,
...
@Composable
private fun MovieWatchlistItem(
    movie: Movie,
    removed: Boolean,
